...
try
    ...
    while(rs.next())
        ...
        h1.setAttribute("city",rs.getString(9));
                     ...
                     out.println("<tr><td><b>USERID</b></td><td>"+rs.getString(2)+"</td></tr>");
                     out.println("<tr><td><b>USERNAME</b></td><td>"+rs.getString(3)+"</td></tr>");
                     out.println("<tr><td><b>EMAIL-ID</b></td><td>"+rs.getString(1)+"</td></tr>");
