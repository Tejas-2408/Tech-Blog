        ...
        <div class="container" style="margin-top: 60px ">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <img src="images/17.JPG class="img-responsive img-thumbnail"width="100%"/>
                    </div>
                </div>
            </div>
            ...
            <div class="jumbotron">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <form method="get" action="SiteController">
                            ...
                            <tr><td><b>FEEDBACK</b></td><td><textarea name="feedbacks" size="30"rows="5" cols="30"></textarea></td></tr>
